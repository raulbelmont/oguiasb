...
class Senha extends CRUD
{
    ...
    {
        $sql = "INSERT INTO $this->table (id, senha, usuario_id) VALUES (:id,:senha, :usuario_id)";
    ...
    public function redefinirSenha($usuario_id, $novaSenha)
    {
        $sql = "UPDATE $this->table SET senha = :senha WHERE usuario_id = :usuario_id";
        $stmt = Conecta::prepare($sql);
